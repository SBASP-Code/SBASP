...
ofstream mycout01("//scratch//lxwu//2026//SBASP//Results//A3//Solution//B" + num2str(B) + "_S" + num2str(S) + "_CN" + num2str(CNN) + "_Code_" + num2str(CODE) + ".txt");
ofstream mycout02("//scratch//lxwu//2026//SBASP//Results//A3//Computational//B" + num2str(B) + "_S" + num2str(S) + "_CN" + num2str(CNN) + "_Code_" + num2str(CODE) + ".txt");
